        ...
        jQuery('.testimonials-carousel').each(function(){
            ...
            function testAct(awidth, containerWidth, getWidth, carouselPop) {
                ...
                if(awidth > containerWidth){
                    jQuery('#testimonial-pr-nx-'+offset).show();
                    carouselPop.children('.carousel-list').css('width', awidth+'px');
                }else{
                    jQuery('#testimonial-pr-nx-'+offset).hide();
            ...
            function testvids() {
                var carouselPop = jQuery('#testimonials-'+offset);
                ...
                jQuery('#testimonial-pr-nx-'+offset).children('div').children('div').click(function(){
                    var handler = arguments.callee;
                    jQuery('#testimonial-pr-nx-'+offset).children('div').children('div').off("click", handler);
                    ...
                    if(getclass == 'next'){
                        carouselPop.children('.carousel-list').animate({
                            ...
                            jQuery('#testimonial-pr-nx-'+offset).children('div').children('div').click(handler);
                        });
                    }
